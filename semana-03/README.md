...
Utilizar un elemento como lo son los sintetizadores como un instrumento pedagógico. Comprendo el valor de la documentación de esta práctica y voy a darle más importancia. Creo que la elección de las palabras para describir las cosas es crucial.

Recuerdo una clase de mi diplomado de medio ambiente donde hablamos de la parálisis climática, que es cuando el problema que se presenta parece tan complejo que te inmoviliza a no actuar. Yo creo que lo mismo puede ocurrir cuando te enfrentas a una disciplina o práctica desconocida. Por eso me parece crucial ese primer acercamiento, y si ese acercamiento puede tener su propio lenguaje formal, simbólico y material.

Esto se menciona en la necesidad de crear un glosario, inciso de la tesis.

Como se menciona, la democratización del acceso a la síntesis sonora, que es algo que esta tesis imparte al eliminar software de pago y hacer investigaciones en español.

Comprender y potenciar las capacidades locales artísticas, popularizar la producción de ruido para fines artísticos, hegemónicos de la música: armónicos, melódicos, escalas musicales, medios para categorizar; darle la vuelta al valor de la experimentación, a jugar con los sonidos.
...
Conversando con Aaron sobre mis alcances de este borrador de tesis, un futuro proyecto podría venir de los platillos de cueca chora, ya que usarlos los destruye; la metáfora de esa fragilidad, referencia de Petter Blasser, sin interés en la pretensión de la precisión y la rapidez.
